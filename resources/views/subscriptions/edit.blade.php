...
@section('content')
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <form method="POST" action="{{ route('subscriptions.subscription.update', $subscription->id) }}" id="edit_subscription_form" name="edit_subscription_form" accept-charset="UTF-8" class="form-horizontal">
            {{ csrf_field() }}
