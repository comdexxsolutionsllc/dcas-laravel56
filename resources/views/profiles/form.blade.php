    ...
    <div class="col-md-10">
        <select class="form-control" id="user_id" name="user_id">
            <option value="" style="display: none;"
                    {{ old('user_id', optional($profile)->user_id ?: '') == '' ? 'selected' : '' }} disabled selected>
                Select user
            </option>
...
<div class="form-group {{ $errors->has('address_1') ? 'has-error' : '' }}">
    ...
    <div class="col-md-10">
        <input class="form-control" name="address_1" type="text" id="address_1"
               value="{{ old('address_1', optional($profile)->address_1) }}" maxlength="255"
...
<div class="form-group {{ $errors->has('address_2') ? 'has-error' : '' }}">
    ...
    <div class="col-md-10">
        <input class="form-control" name="address_2" type="text" id="address_2"
               value="{{ old('address_2', optional($profile)->address_2) }}" maxlength="255"
...
<div class="form-group {{ $errors->has('city') ? 'has-error' : '' }}">
    ...
    <div class="col-md-10">
        <input class="form-control" name="city" type="text" id="city"
               value="{{ old('city', optional($profile)->city) }}" maxlength="255" placeholder="Enter city here...">
...
<div class="form-group {{ $errors->has('state') ? 'has-error' : '' }}">
    ...
    <div class="col-md-10">
        <input class="form-control" name="state" type="text" id="state"
               value="{{ old('state', optional($profile)->state) }}" maxlength="255" placeholder="Enter state here...">
...
<div class="form-group {{ $errors->has('postal_code') ? 'has-error' : '' }}">
    ...
    <div class="col-md-10">
        <input class="form-control" name="postal_code" type="text" id="postal_code"
               value="{{ old('postal_code', optional($profile)->postal_code) }}" maxlength="255"
...
<div class="form-group {{ $errors->has('country') ? 'has-error' : '' }}">
    ...
    <div class="col-md-10">
        <input class="form-control" name="country" type="text" id="country"
               value="{{ old('country', optional($profile)->country) }}" min="0" max="255"
...
<div class="form-group {{ $errors->has('country_code') ? 'has-error' : '' }}">
    ...
    <div class="col-md-10">
        <input class="form-control" name="country_code" type="number" id="country_code"
               value="{{ old('country_code', optional($profile)->country_code) }}" min="0" max="4294967295"
...
<div class="form-group {{ $errors->has('npa_nxx_suffix') ? 'has-error' : '' }}">
    ...
    <div class="col-md-10">
        <input class="form-control" name="npa_nxx_suffix" type="number" id="npa_nxx_suffix"
               value="{{ old('npa_nxx_suffix', optional($profile)->npa_nxx_suffix) }}" min="0" max="4294967295"
               placeholder="Enter npa nxx suffix here...">
...
<div class="form-group {{ $errors->has('phone_type') ? 'has-error' : '' }}">
    ...
    <div class="col-md-10">
        <select class="form-control" id="phone_type" name="phone_type">
            <option value="" style="display: none;"
                    {{ old('phone_type', optional($profile)->phone_type ?: '') == '' ? 'selected' : '' }} disabled
