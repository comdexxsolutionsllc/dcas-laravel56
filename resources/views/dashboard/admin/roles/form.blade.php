...
<div class="form-group {{ $errors->has('guard_name') ? 'has-error' : '' }}">
    ...
    <div class="col-md-10">
        <input class="form-control" name="guard_name" type="text" id="guard_name" value="{{ old('guard_name', optional($role)->guard_name) }}" minlength="1" maxlength="255" required="true" placeholder="Enter guard name here...">
