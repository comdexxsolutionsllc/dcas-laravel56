...
return [
    ...
    /*
     ...
     |
     */
    'command'    => 'java -jar /home/alexrenner/bin/schemaSpy.jar',
    ...
    */
    'parameters' => [
        '-t'         => 'mysql',
        '-u'         => 'dcas',
        '-dp'        => '/usr/share/java/mysql-connector-java-8.0.12.jar',
        // download from http://dev.mysql.com/downloads/connector/j/
        '-hq'        => null,
        '-connprops' => '/home/alexrenner/Code/dcas-laravel56/connprops.properties',
        '-db'        => 'dcas',
    ],
];
