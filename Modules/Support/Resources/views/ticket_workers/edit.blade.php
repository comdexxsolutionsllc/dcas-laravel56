...
@section('content')
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-heading clearfix">
            ...
            <div class="pull-left">
                <h4 class="mt-5 mb-5">{{ !empty($title) ? $title : 'Ticket Workers' }}</h4>
            </div>
        ...
        <div class="panel-body">
            ...
            <form method="POST" action="{{ route('ticket_workers.ticket_workers.update', $ticketWorkers->id) }}"
                  id="edit_ticket_workers_form" name="edit_ticket_workers_form" accept-charset="UTF-8"
