 ...
 * @method static \Illuminate\Database\Eloquent\Builder|\Modules\Support\Entities\TicketComments orderByDislikesCount($direction = 'desc')
 * @method static \Illuminate\Database\Eloquent\Builder|\Modules\Support\Entities\TicketComments orderByLikesCount($direction = 'desc')
 * @method static \Illuminate\Database\Eloquent\Builder|\Modules\Support\Entities\TicketComments whereDislikedBy($userId = null)
 * @method static \Illuminate\Database\Eloquent\Builder|\Modules\Support\Entities\TicketComments whereLikedBy($userId = null)
 */
class TicketComments extends BaseModel
{

    use HasTags, Likeable, SoftDeletes;
