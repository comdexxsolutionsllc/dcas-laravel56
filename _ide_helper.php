 ...
 * Generated for Laravel 5.6.30 on 2018-08-08 16:19:27.
 *
...
namespace Bpocallaghan\Notify\Facades { 
    ...
    class Notify {
         ...
         * @static 
         */ 
        public static function info($title, $content, $icon = true, $iconSmall = true)
        {
            return \Bpocallaghan\Notify\Notify::info($title, $content, $icon, $iconSmall);
        }
         ...
         * @static 
         */ 
        public static function success($title, $content, $icon = true, $iconSmall = true)
        {
            return \Bpocallaghan\Notify\Notify::success($title, $content, $icon, $iconSmall);
        }
         ...
         * @static 
         */ 
        public static function error($title, $content, $icon = true, $iconSmall = true)
        {
            return \Bpocallaghan\Notify\Notify::error($title, $content, $icon, $iconSmall);
        }
         ...
         * @static 
         */ 
        public static function danger($title, $content, $icon = true, $iconSmall = true)
        {
            return \Bpocallaghan\Notify\Notify::danger($title, $content, $icon, $iconSmall);
        }
         ...
         * @static 
         */ 
        public static function warning($title, $content, $icon = true, $iconSmall = true)
        {
            return \Bpocallaghan\Notify\Notify::warning($title, $content, $icon, $iconSmall);
        }
         ...
         * @static 
         */ 
        public static function message($level, $title, $content, $icon, $iconSmall, $timeout = 5000)
        {
            return \Bpocallaghan\Notify\Notify::message($level, $title, $content, $icon, $iconSmall, $timeout);
        }
...
namespace  { 
    ...
    class Alert extends \Bpocallaghan\Notify\Facades\Notify {}
